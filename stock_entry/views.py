...
class StockEntryCreateView(CreateView):
  ...
  def get_success_url(self):
    messages.add_message(self.request, messages.SUCCESS, "Entrada cadastrada com sucesso !")
...
class StockEntryUpdateView(UpdateView):
  ...
  def get_success_url(self):
    messages.add_message(self.request, messages.SUCCESS, "Entrada atualizada com sucesso !")
    return reverse('stock_entry:main')
