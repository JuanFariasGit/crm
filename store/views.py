...
class StoreCreateView(CreateView):
  ...
  def get_success_url(self):
    messages.add_message(self.request, messages.SUCCESS, "Loja cadastrada com sucesso !")
...
class StoreUpdateView(UpdateView):
  ...
  def get_success_url(self):
    messages.add_message(self.request, messages.SUCCESS, "Loja atualizada com sucesso !")
    return reverse('store:main')
